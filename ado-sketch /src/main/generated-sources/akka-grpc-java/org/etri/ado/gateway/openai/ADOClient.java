...
public abstract class ADOClient extends ADOClientPowerApi implements ADO, AkkaGrpcClient {
  ...
  protected final static class DefaultADOClient extends ADOClient {
      ...
      private final SingleResponseRequestBuilder<com.google.protobuf.StringValue, org.etri.ado.gateway.openai.OpenAI.AgentRef> getAgentByIdRequestBuilder(Future<ManagedChannel> channel){
        return new JavaUnaryRequestBuilder<>(getAgentByIdDescriptor, channel, options, settings, ec);
      }
    
  
    
      private final SingleResponseRequestBuilder<org.etri.ado.gateway.openai.OpenAI.Capabilities, org.etri.ado.gateway.openai.OpenAI.Agents> getAgentOfRequestBuilder(Future<ManagedChannel> channel){
        return new JavaUnaryRequestBuilder<>(getAgentOfDescriptor, channel, options, settings, ec);
      }
    
  
    
      private final SingleResponseRequestBuilder<com.google.protobuf.StringValue, org.etri.ado.gateway.openai.OpenAI.Observation> getObservationRequestBuilder(Future<ManagedChannel> channel){
         ...
         */
        public CompletionStage<org.etri.ado.gateway.openai.OpenAI.AgentRef> getAgentById(com.google.protobuf.StringValue request) {
         ...
         */
        public CompletionStage<org.etri.ado.gateway.openai.OpenAI.Agents> getAgentOf(org.etri.ado.gateway.openai.OpenAI.Capabilities request) {
         ...
         */
        public CompletionStage<org.etri.ado.gateway.openai.OpenAI.Observation> getObservation(com.google.protobuf.StringValue request) {

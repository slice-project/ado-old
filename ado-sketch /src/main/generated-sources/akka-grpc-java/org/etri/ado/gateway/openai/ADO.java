...
public interface ADO {
  ...
  CompletionStage<org.etri.ado.gateway.openai.OpenAI.AgentRef> getAgentById(com.google.protobuf.StringValue in);
  
  CompletionStage<org.etri.ado.gateway.openai.OpenAI.Agents> getAgentOf(org.etri.ado.gateway.openai.OpenAI.Capabilities in);
  
  CompletionStage<org.etri.ado.gateway.openai.OpenAI.Observation> getObservation(com.google.protobuf.StringValue in);

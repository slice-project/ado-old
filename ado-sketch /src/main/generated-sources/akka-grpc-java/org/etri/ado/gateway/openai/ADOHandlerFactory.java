...
import static org.etri.ado.gateway.openai.ADO.Serializers.*;
  ...
  public class ADOHandlerFactory {
     ...
     * several services.
     */
    public static Function<HttpRequest, CompletionStage<HttpResponse>> create(ADO implementation, Materializer mat, Function<ActorSystem, Function<Throwable, Status>> eHandler, ActorSystem system) {
     ...
     * Registering a gRPC service under a custom prefix is not widely supported and strongly discouraged by the specification.
     */
    public static Function<HttpRequest, CompletionStage<HttpResponse>> create(ADO implementation, String prefix, Materializer mat, Function<ActorSystem, Function<Throwable, Status>> eHandler, ActorSystem system) {
     ...
     * Use `akka.grpc.javadsl.ServiceHandler.concatOrNotFound` when combining several services.
     */
    public static Function<HttpRequest, CompletionStage<HttpResponse>> partial(ADO implementation, String prefix, Materializer mat, Function<ActorSystem, Function<Throwable, Status>> eHandler, ActorSystem system) {
      return (req -> {
    ...
    private static CompletionStage<HttpResponse> handle(HttpRequest request, String method, ADO implementation, Materializer mat, Function<ActorSystem, Function<Throwable, Status>> eHandler, ActorSystem system) {

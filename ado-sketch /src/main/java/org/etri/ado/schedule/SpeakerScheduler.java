...
public class SpeakerScheduler extends AbstractActor {
	...
	public SpeakerScheduler(AgentSystem system) {
		m_system = system;
	}
	...
	public void preStart() {
		try {
			...
			m_handlers.add(new SpeakActionBuilder());
		}
		catch ( Throwable e ) {

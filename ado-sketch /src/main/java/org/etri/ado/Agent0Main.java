...
public class Agent0Main {	
	...
	public static void main(String[] args) throws Exception {
		...
		ActorRef locationUpdater = system.actorOf(LocationUpdater.props(system, "agent0"));
		ActorRef velocityUpdater = system.actorOf(VelocityUpdater.props(system, "agent0"));
